...
function sum(a, b) { 
    var math = a + b;
    var summary = 'The sum of 4 and 7 is ' + math + '.';
    return [math, summary];
}
...
function multiply(a, b) { 
    var multiply = a * b;
    var summary = 'The product of 5 and 9 is ' + multiply + '.';
...
function multiplyAnyArray(dynamicArray) { 
    ...
    var summary = 'The numbers ' + testDynamicArray + ' have a product of ' + product + '.';
    return [product, summary];
}
